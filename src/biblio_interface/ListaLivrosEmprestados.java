...
public class ListaLivrosEmprestados extends JPanel implements ComponentListener {
    ...
    public void listaLivrosEmprestados(TelaPrincipal telaPrincipal) {

        this.addComponentListener(this);
        Map<String,Livro> LivrosEmprestados= new HashMap<>();
        for(Map.Entry<String,Livro> exibir:  telaPrincipal.principal.listaLivrosEmprestados().entrySet()) {
        ...
        JLabel cabecalho = new JLabel("Lista de Livros", JLabel.CENTER);
        cabecalho.setFont(new Font("Arial", Font.BOLD, 28));
        tabela = new JTable();
        modelo = new ModeloTabela(livros);
        ...
        informacoes.addActionListener((ActionEvent ae) -> {
            if (tabela.getSelectedRow() != -1) {
				...
				Livro livro= modelo.getLivro(tabela.getSelectedRow());
