...
public class ListaLivros extends JPanel implements ComponentListener {
    ...
    public ListaLivros(TelaPrincipal telaPrincipal) {

        this.addComponentListener(this);
        this.livros= telaPrincipal.principal.listaLivro();
        
        System.out.println("classe listalivro");
